...
import com.liferay.revisited.model.EmployeeTable;
...
import com.liferay.revisited.service.persistence.impl.constants.virtualPersistenceConstants;
...
public class EmployeePersistenceImpl
	...
	@Override
	@Reference(
		target = virtualPersistenceConstants.SERVICE_CONFIGURATION_FILTER,
		unbind = "-"
	)
	...
	@Override
	@Reference(
		target = virtualPersistenceConstants.ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER,
		unbind = "-"
	)
